...
namespace Iridio.MembershipProvider
{
  public class IridioMembershipProvider : System.Web.Security.MembershipProvider
  {
    ...
    private const string eventSource = "IridioMembershipProvider";
    ...
    {
      return this.CreateUser(username, password, email, passwordQuestion, passwordAnswer, isApproved, out status);
    }
    ...
    public override MembershipUser GetUser(string userName, bool userIsOnline)
    {
      ...
      try
      {
        ...
        if (mu != null)
        {
          //Removed LastActivityDate to bypass the updates to the server 
          //if (userIsOnline)
          //{
    ...
    public override MembershipUser GetUser(object providerUserKey, bool userIsOnline)
    {
      ...
      try
      {
        ...
        if (mu != null)
        {
          //Removed to bypass the updates to the db
          //if (userIsOnline)
          //{
          //mu.LastActivityDate = DateTime.Now;
          //repository.Save(mu);
    ...
    {
      if (user == null)
        throw new MemberAccessException("User can not be null");
